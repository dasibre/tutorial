 ...
 before { @user = User.new(name: "Example User", 
  ...
  it { should be_valid }
    ...
    describe "when password is not present" do
     ...
     describe "when password and password confirmation dont match" do
    ...
    describe "when name is not present" do
      ...
      describe "when email is case insensivite" do
               before do
                 user_with_uppercase_email =  @user.dup
                 user_with_uppercase_email.email = @user.email.upcase
      ...
      describe "remember token" do
         before { @user.save }
         its(:remember_token) { should_not be_blank } #its method equivalent to it( @user.remember_token.should_not be_blank      
      end
end
